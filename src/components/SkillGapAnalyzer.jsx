...
export default function SkillGapAnalyzer() {
  ...
  const loadExample = () => {
    setResume(`Experienced Python developer with 5 years in machine learning. Strong background in TensorFlow, scikit-learn, and Docker. Built production APIs with Flask and FastAPI. Proficient in SQL, data analysis with Pandas, and cloud deployment on AWS. Currently learning PyTorch for deep learning projects.`)
  }
